...
- A workbook with at least one sheet (complete [Creating Your First Workbook](/tutorials/creating-your-first-workbook) if you haven't already)
...
![Empty Sheet](/assets/tutorials/adding-columns/02a-empty-sheet-rightclick.png)
...
![Right-Click Context Menu](/assets/tutorials/adding-columns/02b-rightclick-context-menu.png)

2. Select **"Add Column"** from the context menu

3. The "Add Column" dialog will open directly

![Add Column Dialog](/assets/tutorials/adding-columns/02c-add-column-dialog-rightclick.png)
...
![Add Column Filled](/assets/tutorials/adding-columns/05-add-column-filled.png)
...
There's also **Compute Columns** that automatically calculate values based on formulas. Right-click and select "Add Compute Column" to create one. Learn more in the [Computed Columns tutorial](/tutorials/computed-columns).
:::
...
![Sheet with Columns](/assets/tutorials/adding-columns/09-sheet-with-columns.png)
...
![Right-Click Column Header](/assets/tutorials/adding-columns/10-rightclick-edit-context-menu.png)
...
![Edit Column Dialog](/assets/tutorials/adding-columns/11-edit-column-dialog.png)
...
Learn more about the Column Management Page and its features in our [Column Management guide](/guides/column-management).
...
- **[Add Data to Your Sheet](/tutorials/adding-data)** - Start entering information into your sheet
- **[Column Management Page](/guides/column-management)** - Learn about comprehensive column management features
- **[Import Existing Data](/tutorials/importing-data)** - Bring in data from CSV or Excel files
...
- Read the [Column Management guide](/guides/column-management)
