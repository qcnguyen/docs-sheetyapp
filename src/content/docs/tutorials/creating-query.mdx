...
- Complete the [Creating Your First Workbook](/tutorials/creating-your-first-workbook) tutorial
...
![Empty Queries Page](/assets/tutorials/creating-query/01-queries-page.png)
...
![Add Query Form](/assets/tutorials/creating-query/02-add-query-form.png)
...
![Query Form Filled](/assets/tutorials/creating-query/03-query-form-filled.png)
...
For example:
- To filter only Engineering department: `@Department.Text = 'Engineering'`
- To filter salaries above 50000: `@Salary > 50000`
- To combine conditions: `@Department.Text = 'Engineering' and @Salary > 50000`
...
![Query Result](/assets/tutorials/creating-query/04-query-result.png)
...
1. **Use it in an App**: Queries are required for adding widgets to apps. See [Creating Your First App](/tutorials/creating-app) to learn how to use queries in widgets.
