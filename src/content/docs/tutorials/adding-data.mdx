...
- A sheet with columns defined (complete [Adding Columns to Your Sheet](/tutorials/adding-columns) if you haven't already)
...
![Empty Sheet with Columns](/assets/tutorials/adding-data/01-empty-sheet.png)
...
![Add Row Dialog](/assets/tutorials/adding-data/02-add-row-dialog.png)
...
![Filled Row Data](/assets/tutorials/adding-data/03-filled-row-data.png)
...
![First Row Added](/assets/tutorials/adding-data/04-first-row-added.png)
...
![Multiple Rows](/assets/tutorials/adding-data/05-multiple-rows.png)
...
![Placeholder Row](/assets/tutorials/adding-data/07-inline-editing-start.png)
...
![Inline Editing Email](/assets/tutorials/adding-data/08-inline-editing-email.png)
...
![Inline Editing Complete](/assets/tutorials/adding-data/09-inline-editing-complete.png)

### Step 5: Save the Row

Once all fields are filled, click the **Save** button that appears on the right side of the row.

![Inline Editing Saved](/assets/tutorials/adding-data/10-inline-editing-saved.png)
...
![Edit Row Dialog](/assets/tutorials/adding-data/06-edit-row-dialog.png)
...
![Inline Edit Existing](/assets/tutorials/adding-data/11-inline-edit-existing.png)

3. Make your changes
4. Press **Enter** to save the change

![Inline Edit Saved](/assets/tutorials/adding-data/12-inline-edit-saved.png)
...
- **[Import Bulk Data](/tutorials/importing-data)** - Learn how to import data from CSV or Excel files
- **[Filter and Search Data](/tutorials/filtering-data)** - Find specific information in your sheets
- **[Sort and Organize Data](/tutorials/sorting-data)** - Arrange your data for better analysis
- **[Export Your Data](/tutorials/exporting-data)** - Download your data in various formats
...
A: Yes! You can import multiple rows using CSV or Excel files. Check out the [Importing Data](/tutorials/importing-data) tutorial.
...
- Learn about [Data Validation](/concepts/data-validation)
