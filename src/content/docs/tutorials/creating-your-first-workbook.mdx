...
![Sheety App Home Page](/assets/tutorials/first-workbook/01-home-page.png)
...
![Create Workbook Form](/assets/tutorials/first-workbook/02-create-workbook-form.png)
...
![Create Workbook Form Filled](/assets/tutorials/first-workbook/03-create-workbook-filled.png)
...
![Workbook Welcome Page](/assets/tutorials/first-workbook/04-workbook-welcome.png)
...
![Create Sheet Form](/assets/tutorials/first-workbook/05-create-sheet-form.png)

3. For this tutorial, let's create an employee sheet:
   - **Name**: `Employees`
   - **Description**: `A sheet to manage employee information`

![Create Sheet Form Filled](/assets/tutorials/first-workbook/06-create-sheet-filled.png)
...
![Empty Sheet View](/assets/tutorials/first-workbook/07-empty-sheet.png)
...
- **[Add Columns to Your Sheet](/tutorials/adding-columns)** - Learn how to define your data structure
- **[Import Data](/tutorials/importing-data)** - Import existing data from CSV or Excel
- **[Build Your First App](/tutorials/building-apps)** - Create a custom app to interact with your data
- **[Set Up API Access](/tutorials/api-access)** - Connect your data to external applications
