...
- Basic understanding of [Adding Columns](/tutorials/adding-columns)
...
![Add Column with Number Type](/assets/tutorials/column-validation/01-add-column-number-type.png)
...
![Validation Tab - Empty](/assets/tutorials/column-validation/02-validation-tab-empty.png)
...
![Add Validation Menu](/assets/tutorials/column-validation/03-add-validation-menu.png)
...
![Min Value Validation](/assets/tutorials/column-validation/04-min-value-validation.png)
...
![Validation Rule Added](/assets/tutorials/column-validation/05-validation-rule-added.png)
...
![Empty Add Row Form](/assets/tutorials/column-validation/06-add-row-form-empty.png)
...
![Form with Invalid Value](/assets/tutorials/column-validation/07-form-with-invalid-value.png)
...
![Validation Error Displayed](/assets/tutorials/column-validation/08-validation-error-displayed.png)
...
![Form with Valid Value](/assets/tutorials/column-validation/09-form-with-valid-value.png)
...
![Successful Save](/assets/tutorials/column-validation/10-successful-save.png)
...
Learn more about Q-Expressions in our [Q Expressions Reference](/q-expressions).
...
- **[Adding Data to Your Sheet](/tutorials/adding-data)** - Start entering validated data
- **[Column Management](/guides/column-management)** - Learn more about column features
- **[Q Expressions Reference](/q-expressions)** - Create advanced validation with Q-Expressions
- **[Import Data](/tutorials/importing-data)** - Understand how validation affects imports
...
- Learn about [Q Expressions](/q-expressions) for advanced validation
