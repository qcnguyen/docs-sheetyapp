...
While the Columns management page is great for comprehensive column management, you can also add columns quickly by **right-clicking on the data grid**. This opens a context menu with "Add Column" option. Learn more in [Adding Columns to Your Sheet](/tutorials/adding-columns).

## What's Next?

After managing your columns:

- **[Add Data to Your Sheet](/tutorials/adding-data)** - Start entering information
- **[Set Up Column Validation](/tutorials/column-validation)** - Add rules to ensure data quality
- **[Create Computed Columns](/tutorials/computed-columns)** - Build columns with automatic calculations
- **[Column Data Types Reference](/concepts/column-types)** - Detailed information about each data type
...
- Learn about [Column Data Types](/concepts/column-types)
